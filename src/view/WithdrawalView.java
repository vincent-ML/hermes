...
public class WithdrawalView extends JPanel {
private JLabel jlDocumentID,jlDocumentRegistration, jlcedula, jlphone, jlMemberId, jlMemberName, jlMemberLastName;
private JLabel jlTypeOfDocument, jlAmountMoney, jlTypeWithdrawal,jlStatus,jlDate,jlTime;
...
public JTextField jtfDocumentID,jtfMemberId, jtfMemberName, jtfMemberLastName, jtfAmountMoney,jtfcedula, jtfphone;
private JTextField jtfTypeOfDocument, jtfTypeWithdrawal,jtfStatus,jtfDate,jtfTime;
...
public WithdrawalView(){
        ...
        jlDocumentRegistration = new JLabel("Withdrawal Information");
        ...
        jlTypeWithdrawal = new JLabel("Type of Withdrawal:       ");
        ...
        jtfTypeWithdrawal = new JTextField(14);
        jtfTypeWithdrawal.setToolTipText("Withdrawal category");
        jtfTypeWithdrawal.setBackground(new Color(64,64,64));
        jtfTypeWithdrawal.setFont(new Font("Futura Heavy", Font.BOLD, 15));
        jtfTypeWithdrawal.setForeground(new Color(216,218,218));
        jtfTypeWithdrawal.setBorder(border);
        jtfTypeWithdrawal.setEditable(false);
        gridBagConstraintDocument.gridx = 1;
        gridBagConstraintDocument.gridy = 4;
        jpDocument.add(jtfTypeWithdrawal,gridBagConstraintDocument);
...
public void setDocumentInfo(int documentId,double documentMoneyAmount,String documentType,String memberID,
                            ...
                            String memberPhoneNumber,String memberCedula,String withdrawalType){
        ...
        jtfTypeWithdrawal.setText(withdrawalType);
